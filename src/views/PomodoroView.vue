  ...
  <Navbar/>
    <div class="digital-clock">
        ...
        <div class="time">
            ...
            <span class="minutes">{{displaySeconds}}</span>
        </div>
        <form>
          <div class="form">
            <div class="nes-field">
    ...
    methods:{
        onClicked(){
          ...
          if(this.isActive){
            ...
            document.querySelector(".set").innerHTML = "Disabled"
            document.querySelector(".set").disabled = true;
            this.clock(this.minute);
            this.isActive = !this.isActive; 
          }
            console.log(this.isActive, this.minute, this.song, this.audio)
        ...
        clock(timerr){
            ...
            const timer = setInterval(()=>{
                ...
                if(time > 0){
                    ...
                    document.querySelector(".set").disabled = false;
                    this.minute=""
                    this.audio.pause();
                    clearInterval(timer);
                    this.displayMinutes = minutes < 10 ? this.displayMinutes = "0" + minutes: this.displayMinutes = minutes;
